...
> **Status:** v0.3.2 — adds an auto-recharge-and-resume switch, plus a reliability fix for long-running installs. Tested on Lymow One. **Lymow One Plus** is expected to work but is unverified — please open an issue if you have one.
